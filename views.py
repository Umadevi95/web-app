...
#data_for_prediction =obj.pca(np.array(data_for_prediction),y_test)
            ...
            return render(request, "succ_msg.html", {'data_no_of_dependents':data_no_of_dependents,'data_loan_amount':data_loan_amount,'data_loan_term':data_loan_term,'data_cibil_score':data_cibil_score,
                                                        'out':out})
